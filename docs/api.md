...
`path_or_array` may be a path or a NumPy array. NumPy array inputs are interpreted
as OpenCV-style BGR/BGRA arrays. The method returns an RGB/RGBA NumPy array
