...
title: Changelog
heading: Changelog
lead: Notable changes, including high-visibility migration notes for v2.
description: autocrop changelog and migration notes.
---
...
#### Face detection
* YuNet is the only detector.
* Haar cascade detection, `--detector`, and the bundled Haar XML file were removed.
* The vendored OpenCV Zoo YuNet ONNX model is used through OpenCV.

#### Image adjustment
* Automatic gamma/exposure adjustment was removed.
* If output brightening or color correction is needed, post-process the returned NumPy array or compose autocrop with dedicated image tools.

#### Packaging and development
* Project and tool configuration are centralized in `pyproject.toml`.
